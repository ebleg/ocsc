function [x_new] = state_transition3(x, k, u, alpha_enter_fcn, C_fcn, Co_fcn, par)
...
% x = [queue_left, queue_straight, queue_right, total # cars]
    ...
    tau = floor((C_fcn(k) - [1 1 1 0]*x)*par.l_veh...
                 /par.N_lane/par.v_free/par.c);
    gamma = rem((C_fcn(k) - [1 1 1 0]*x)*par.l_veh*par.N_lane/par.v_free, ...
                par.c);
